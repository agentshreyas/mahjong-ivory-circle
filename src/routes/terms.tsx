      ...
      <article className="mx-auto max-w-2xl px-6 py-16 md:py-24">
        ...
        <div className="mt-10 space-y-8 text-[14px] leading-relaxed text-[var(--taupe)]">
          ...
          <S title="2. Applications & invitations">
            ...
            decline, or defer any request without giving reasons. Invitations are personal and
            non-transferable.
          </S>
          ...
          <S title="4. Fees & purchases">
            The Circle itself has no application fee. Certain salons, tournaments and collection
            items are priced separately and governed by their own purchase terms at the point of
            order.
          </S>
          ...
          <S title="9. Governing law">
            ...
            jurisdiction, subject to any mandatory consumer rights you may have.
          </S>
          <S title="10. Changes">
            We may update these terms from time to time. Material changes will be notified via the
            site or email. Continued use after a change constitutes acceptance.
          </S>
          <S title="11. Contact">
          ...
          <p className="italic">
            This draft is provided for review and will be finalised before the Circle opens to
            members.
          </p>
        </div>
